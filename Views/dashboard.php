                        ...
                        <div class="card" style="padding: 10px;">
                            <div class="flex flex-col items-center p-8 rounded-md w-60 sm:px-12 dark:bg-gray-900 dark:text-gray-100">
                                <div class="text-center">
                                    ...
                                    <p class="text-sm dark:text-gray-400">July 25</p>
                                </div>
                                ...
                                <div class="mb-2 text-3xl font-semibold">34°
                                    <span class="mx-1 font-normal">/</span>21°
                                </div>
                                <p class="dark:text-gray-400">Partly cloudy</p>
                            </div>
                        </div>
                    </div>
