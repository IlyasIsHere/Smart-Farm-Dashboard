                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card" style="padding: 10px;">
                            <div class="flex flex-col items-center p-8 rounded-md w-60 sm:px-12 dark:bg-gray-900 dark:text-gray-100">
                                <div class="text-center">
                                    <h2 class="text-xl font-semibold"><?php echo $weatherData['name']; ?></h2>
                                    <p class="text-sm dark:text-gray-400"><?php echo date('F j', $weatherData['dt']); ?></p>
                                </div>
                                <div class="svg-container">
                                    ...
                                    ?>
                                    <img src="<?php echo $weatherIconUrl; ?>" alt="Weather Icon" class="weather-icon">
                                </div>
                                <div class="mb-2 text-3xl font-semibold">
                                    <?php echo round($weatherData['main']['temp'] - 273.15); ?>°
                                    <span class="mx-1 font-normal">/</span>
                                    <?php echo round($weatherData['main']['temp_min'] - 273.15); ?>°
                                </div>
                                <p class="dark:text-gray-400"><?php echo ucwords($weatherData['weather'][0]['description']); ?></p>
                            </div>
                        </div>
                    </div>
